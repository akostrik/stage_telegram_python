...
2) Constant improvement of its results by the mean of the Learning service (that is attaching of some previous OpenIA responses, corriged by a user, to OpenAI requests)
