...
- [Détails techniques du développement](#technical-details-of-the-developement)
   ...
   * [Détails du Serveur 1 (python)](#server-1-python-details)
   * [Détails du Serveur 2 (node.js)](#server-2-nodejs-details)
   * [Détails du Serveur 3 (Vue)](#server-3-vue-details)
...
-  l’utilisation de frameworks (Vue et Express).
